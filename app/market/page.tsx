...
function DetailCard({
  ...
  return (
    <div className={`detail-card ${tone}`}>
      ...
      >
        <div className="market-container">
          ...
          <div className="footer-note">
            این بخش داده‌های بازار را نمایش می‌دهد و
            تحلیل تکنیکال الگوریتمی ارائه می‌کند.
            نتیجه تحلیل به‌تنهایی تضمین‌کننده نتیجه
            معامله نیست.
          </div>
        </div>
      </main>
